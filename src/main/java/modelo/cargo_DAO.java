 ...
 * @author mcifuentes
 */
public class cargo_DAO extends Conexion {
    ...
    public void Insertar(String Nombre) throws Exception
    {
           try{
             getStmt();
	     stmt.executeUpdate("INSERT INTO cargo (nombre) values ('"+Nombre+"')");
        }catch (Exception ex){
    ...
    public void Actualizar(int Id, String Nombre) throws Exception
    {
           try{
             getStmt();
             stmt.executeUpdate("UPDATE cargo set nombre='"+Nombre+ "' WHERE id="+Id);
        }catch (Exception ex){
           System.err.println("SQLException: " + ex.getMessage());
        }
    }
    ...
    public ResultSet Listado()throws Exception
    {
            try{
             getStmt();
	     resultado= stmt.executeQuery("SELECT * FROM cargo");
             return resultado;
              } catch (Exception ex){
           System.err.println("SQLException: " + ex.getMessage());
           return null;
