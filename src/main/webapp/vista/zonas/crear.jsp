                                    ...
                                    <div class="col-sm-6">
                                        <form  method="POST" action="../zona_servlet">
                                            <div class="form-group form-float">
                                                <h2 class="card-inside-title">Nombre del zona</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nombre" required>
                                                    <label class="form-label">Nombre del zona</label>
                                                </div>
                                                <h2 class="card-inside-title">Extension</h2>
                                                <div class="form-line">
