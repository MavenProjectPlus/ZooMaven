                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="../cargo/crear.jsp">Crear</a>
                                </li>
                                <li>
                                    <a href="../cargo/borrar.jsp">Borrar</a>
                                </li>
                                <li>
                                    <a href="../cargo/actualizar.jsp">Actualizar</a>
                                </li>
                                <li>
                                    <a href="../cargo/leer.jsp">Leer</a>
                                </li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <a href="../zona/vegetacion/borrar.jsp">Borrar</a>
                                </li>
                                <li>
                                    <a href="../zona/vegetacion/actualizar.jsp">Actualizar</a>
                                </li>
                                <li>
                                    <a href="../zona/vegetacion/leer.jsp">Leer</a>
                                </li>    
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Creacion de especie</h2>
                            </div>
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <form  method="POST" action="../especie_servlet">
                                            <div class="form-group form-float">
                                                <h2 class="card-inside-title">Nombre del especie</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nombre" required>
                                                    <label class="form-label">Nombre del especie</label>
                                                </div>
                                                <h2 class="card-inside-title">Nombre cientifico</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nombre_cientifico" required>
                                                    <label class="form-label">Nombre cientifico</label>
                                                </div>
                                                <h2 class="card-inside-title">Descripcion</h2>
                                                <div class="form-line">
                                                ...
                                                <h2 class="card-inside-title">Zona</h2>
                                                <div class="form-group form-float">
                                                    <select class="form-control show-tick" name="zona">
                                                        <%
                                                ...
                                                <h2 class="card-inside-title">Cuidador</h2>
                                                <div class="form-group form-float">
                                                    <select class="form-control show-tick" name="empleado">
                                                        <%
                                                            modelo.empleado_DAO empleado = new modelo.empleado_DAO();
                                                            res = empleado.Listado();
                                                            while (res.next()) {
                                                        %>
                                                        <option value=<%=res.getString(1)%>><%=res.getString(2)%></option>
                                                        <%
                                                ...
                                                <h2 class="card-inside-title">Fecha y hora de cuidado</h2>
                                                <div class="form-line">
                                                    <input type="date" class="form-control" name="fecha_cuidado" required>
                                                </div>
                                                <h2 class="card-inside-title">Habitat</h2>
                                                <div class="form-group form-float">
                                                    <select class="form-control show-tick" name="habitat">
                                                        <%
                                            ...
                                            <input class="btn btn-primary waves-effect" type="submit" name="boton" value="Crear"/>
                                        </form>
                                    </div>
                                </div>
                            </div>
