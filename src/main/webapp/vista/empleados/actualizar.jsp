                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <h2 class="card-inside-title">Seleccione un empleado</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <form method="POST" action="../empleado_servlet">
                                            <div class="form-group form-float">
                                                <select class="form-control show-tick" name="id">
                                                    <%
                                                        modelo.empleado_DAO empleado = new modelo.empleado_DAO();
                                                        ResultSet res = empleado.Listado();
                                                        while (res.next()) {
                                                    %>
                                            ...
                                            <div class="form-group form-float">
                                                <h2 class="card-inside-title">Nombre del empleado</h2>
                                                <div class="form-line">
                                                ...
                                                <h2 class="card-inside-title">Fecha de ingreso</h2>
                                                <div class="form-line">
                                                    <input type="date" class="form-control" name="fecha_ingreso" required>
                                                </div>
                                                <h2 class="card-inside-title">Cargo</h2>
                                                <div class="form-group form-float">
                                                    <select class="form-control show-tick" name="cargo">
                                                        <%
                                                            modelo.cargo_DAO cargo = new modelo.cargo_DAO();
                                                            res = cargo.Listado();
                                                            while (res.next()) {
                                                        %>
                                                        <option value=<%=res.getString(1)%>><%=res.getString(2)%></option>
                                            ...
                                            <input class="btn btn-primary waves-effect" type="submit" name="boton" value="Actualizar">
                                        </form>
                                    </div>
                                </div>
                            </div>
