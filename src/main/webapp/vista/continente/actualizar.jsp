            ...
            <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <h2 class="card-inside-title">Seleccione un cargo</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <form method="POST" action="../continente_servlet">
                                            <div class="form-group form-float">
                                        <select class="form-control show-tick" name="id">
                                            <%
                                                modelo.continente_DAO continente = new modelo.continente_DAO();
                                                ResultSet res = continente.Listado();
                                                while (res.next()) {
                                            %>
                                        ...
                                        <div class="form-group form-float">
                                            <h2 class="card-inside-title">Nombre del cargo</h2>
                                        <div class="form-line">
