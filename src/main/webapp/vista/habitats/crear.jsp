            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Creacion de habitat</h2>
                            </div>
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <form  method="POST" action="../habitat_servlet">
                                            <div class="form-group form-float">
                                                <h2 class="card-inside-title">Nombre del habitat</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nombre" required>
                                                    <label class="form-label">Nombre del habitat</label>
                                                </div>
                                                <h2 class="card-inside-title">Clima</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="clima" required>
                                                    <label class="form-label">Clima</label>
                                                </div>
                                                <h2 class="card-inside-title">Vegetacion</h2>
                                                    <div class="form-group form-float">
                                                        <select class="form-control show-tick" name="vegetacion">
                                                            <%
                                                                modelo.vegetacion_DAO vegetacion = new modelo.vegetacion_DAO();
                                                                ResultSet res = vegetacion.Listado();
                                                                while (res.next()) {
                                                            %>
                                                        ...
                                                        <h2 class="card-inside-title">Continente</h2>
                                                    <div class="form-group form-float">
                                                        <select class="form-control show-tick" name="continente">
                                                            <%
                                                                modelo.continente_DAO continente = new modelo.continente_DAO();
                                                                res = continente.Listado();
                                                                while (res.next()) {
                                                            %>
                                                            <option value=<%=res.getString(1)%>><%=res.getString(2)%></option>
                                                            <%
