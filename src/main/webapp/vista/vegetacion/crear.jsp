...
<div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Creacion de vegetacion</h2>
                            </div>
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <form  method="POST" action="../vegetacion_servlet">
                                            <div class="form-group form-float">
                                                <h2 class="card-inside-title">Nombre del vegetacion</h2>
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nombre" required>
                                                    <label class="form-label">Nombre del vegetacion</label>
                                                </div>
                                            </div>
